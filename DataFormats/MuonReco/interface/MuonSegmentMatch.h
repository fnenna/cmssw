...
namespace reco {
  namespace io_v1 {
    ...
    public:
      ...
      static const unsigned int BestInChamberByDX_DPhiDZ = 1 << 25;  // best combined delta x and delta dphidz in single muon chamber
      static const unsigned int BestInStationByDX_DPhiDZ = 1 << 26;  // best combined delta x and delta dphidz in single muon station
      static const unsigned int BelongsToTrackByDX_DPhiDZ = 1 << 27; // best combined delta x and delta dphidz of multiple muons
